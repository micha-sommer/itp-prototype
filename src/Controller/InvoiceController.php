...
class InvoiceController extends AbstractController
{
    ...
    ): Response
    {
        ...
        $this->createInvoicePosition($invoice, 'ITC: Paket A EZ (package A single)', 0, 23500);
        $this->createInvoicePosition($invoice, 'ITC: Paket B EZ (package B single)', 0, 31500);
        $this->createInvoicePosition($invoice, 'ITC: Paket C EZ (package C single)', 0, 39000);
        $this->createInvoicePosition($invoice, 'ITC: Paket D EZ (package D single)', 0, 49000);
        ...
        $this->createInvoicePosition($invoice, 'ITC: Paket A DZ/MBZ (package A shared)', $packACount * 100, 19500);
        $this->createInvoicePosition($invoice, 'ITC: Paket B DZ/MBZ (package B shared)', $packBCount * 100, 27500);
        $this->createInvoicePosition($invoice, 'ITC: Paket C DZ/MBZ (package C shared)', $packCCount * 100, 35000);
        $this->createInvoicePosition($invoice, 'ITC: Paket D DZ/MBZ (package D shared)', $packDCount * 100, 43000);
